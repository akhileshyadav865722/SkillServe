...
function Dashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in font-sans">
      {/* Container Background explicitly left untouched as requested */}

      {/* 1. Header Banner - Light Aurora Glass Theme */}
      <div className="relative bg-white/80 backdrop-blur-xl p-6 sm:p-10 rounded-[32px] mb-10 overflow-hidden border border-white shadow-[0_8px_30px_rgb(0,0,0,0.06)] ring-1 ring-slate-900/5 transition-all hover:shadow-[0_15px_40px_rgba(37,99,235,0.08)]">
        <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-br from-indigo-200 to-cyan-200 opacity-40 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4 pointer-events-none animate-pulse"></div>
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-6 relative z-10">
          <div>
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight mb-2">
              Welcome back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-500 to-cyan-500 drop-shadow-sm">{user?.name?.split(' ')[0]}</span>!
            </h2>
            <p className="text-slate-600 font-bold text-lg drop-shadow-sm">Manage your {user?.role === 'client' ? 'posted requests and talent' : 'opportunities and profile'}.</p>
          </div>

          <div className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-md px-5 py-3 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-shadow ring-1 ring-slate-900/5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="font-extrabold text-slate-900 leading-none">{user?.name}</span>
                <span className="inline-flex items-center rounded-md bg-blue-50 px-2 py-0.5 text-[10px] font-black uppercase tracking-widest text-blue-600 border border-blue-100 shadow-sm">
                  {user?.role}
                </span>
              </div>
              <span className="text-xs text-slate-500 font-bold block truncate max-w-[150px] mt-1">{user?.email}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {user?.role === 'client' ? (
        ...
        <div className="space-y-6">
          <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-blue-700 via-blue-500 to-cyan-400 p-10 sm:p-20 text-center shadow-[0_20px_40px_rgba(37,99,235,0.2)] mb-8 group border-[3px] border-white/40 ring-1 ring-slate-900/5">
            {/* Dynamic Glass Background Elements */}
            <div className="absolute -top-32 -left-32 w-96 h-96 rounded-full bg-white/20 blur-[80px] group-hover:bg-white/30 transition-colors duration-700 group-hover:scale-110"></div>
            <div className="absolute -bottom-32 -right-32 w-[500px] h-[500px] rounded-full bg-cyan-300/20 blur-[100px] group-hover:bg-cyan-300/30 transition-colors duration-700 group-hover:scale-110"></div>

            <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
              <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/20 text-white text-[10px] sm:text-xs font-black tracking-widest border border-white/40 backdrop-blur-md mb-8 uppercase shadow-lg">
                <span className="w-2.5 h-2.5 rounded-full bg-yellow-300 animate-pulse shadow-[0_0_10px_rgba(253,224,71,0.8)]"></span>
              ...
              <h3 className="text-4xl sm:text-5xl lg:text-7xl font-black text-white mb-6 tracking-tight drop-shadow-lg leading-[1.1]">
                Ready to land your <span className="text-cyan-100">next big project?</span>
              </h3>
              <p className="text-lg sm:text-2xl text-white/90 mb-12 font-bold leading-relaxed max-w-2xl px-4 drop-shadow-md">
              ...
              <Link to="/requests" className="inline-flex items-center justify-center gap-3 px-8 sm:px-12 py-5 sm:py-6 bg-white text-blue-600 text-sm sm:text-base font-black uppercase tracking-widest rounded-2xl shadow-[0_15px_30px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)] hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300 group/btn border border-white/50">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8 hidden sm:grid">
            <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[24px] border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-6 hover:shadow-[0_15px_40px_rgba(37,99,235,0.08)] hover:-translate-y-1 hover:border-blue-100 transition-all ring-1 ring-slate-900/5 group">
              <div className="h-16 w-16 shrink-0 rounded-2xl bg-gradient-to-br from-indigo-50 to-blue-50 text-blue-500 flex items-center justify-center font-black text-3xl shadow-inner border border-white ring-1 ring-slate-100 group-hover:scale-110 transition-transform">🚀</div>
              <div>
            ...
            <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[24px] border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-6 hover:shadow-[0_15px_40px_rgba(37,99,235,0.08)] hover:-translate-y-1 hover:border-blue-100 transition-all ring-1 ring-slate-900/5 group">
              <div className="h-16 w-16 shrink-0 rounded-2xl bg-gradient-to-br from-amber-50 to-yellow-50 flex items-center justify-center font-black text-3xl shadow-inner border border-white ring-1 ring-amber-100 group-hover:scale-110 transition-transform">⭐</div>
              <div>
            ...
            <div className="bg-white/80 backdrop-blur-xl p-8 rounded-[24px] border border-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex items-center gap-6 hover:shadow-[0_15px_40px_rgba(37,99,235,0.08)] hover:-translate-y-1 hover:border-blue-100 transition-all ring-1 ring-slate-900/5 group">
              <div className="h-16 w-16 shrink-0 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 text-emerald-500 flex items-center justify-center font-black text-3xl shadow-inner border border-white ring-1 ring-emerald-100 group-hover:scale-110 transition-transform">💎</div>
              <div>
